...
//			File directory = new File(recivedParameter);
			File directory = new File(repository.toString() + File.separatorChar + recivedParameter.toString());
			directory.mkdirs();
...
//			out.println(recivedParameter + File.separatorChar + file.getName());
//			out.println(recivedParameter);
			out.println(base64EncodedImageString);
