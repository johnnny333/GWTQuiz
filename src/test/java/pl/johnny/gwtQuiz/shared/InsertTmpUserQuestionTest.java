...
public class InsertTmpUserQuestionTest extends GWTTestCase {
	 ...
	 * 
	 * Gotta' make a symbolic link to a database: ln -s
	 * ~/workspace.gwt/GWTQuiz/src/main/webapp/quiz_resources
	 * ~/workspace.gwt/GWTQuiz/quiz_resources
	 */
	public void testQuestionService() {
		...
		questionService.insertUserTmpQuestion(new Question("questionDataTest", null,
				new String[] { "TestAnswer1", "TestAnswer2", "TestAnswer3", "TestAnswer4" }, "correctAnswersDataTest",
				"authorDataTest", "Muzyka"), new AsyncCallback<Void>() {
