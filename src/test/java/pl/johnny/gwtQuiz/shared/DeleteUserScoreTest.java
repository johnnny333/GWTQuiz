...
public class DeleteUserScoreTest extends GWTTestCase {
...
//		// Send a request to the server.
		questionService.deleteUserScore(new UserScore(10, "TestuserDisplayUpdate", 11, false, "0000"), new AsyncCallback<Void>() {
