...
public class UpdateUserScoreTest extends GWTTestCase {
...
//	}
	...
	public void testQuestionService() {
		...
		questionService.updateUserScore(new UserScore(1, "TestuserDisplayUpdate", 11, false, "0000"), new AsyncCallback<Void>() {
