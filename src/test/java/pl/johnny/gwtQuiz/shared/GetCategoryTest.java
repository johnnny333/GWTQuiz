...
public class GetCategoryTest extends GWTTestCase {
	...
	public void testQuestionService() {
		...
		questionService.getCategory("Muzyka", new AsyncCallback<String[][]>() {
			
			@Override
			public void onSuccess(String[][] result) {
				System.out.println("Result from getCategory(): " + result[0][1]);
				finishTest();
			}
